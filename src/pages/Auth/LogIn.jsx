      ...
      <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
        <form onSubmit={handleEmailLogin} className="w-full max-w-md">
          ...
          <div className="flex items-center justify-center mt-6">
            <Link
              to="/login"
              className="w-1/3 pb-4 font-medium text-center text-gray-500 capitalize border-b border-blue-500 dark:border-gray-400 dark:text-gray-300"
            >
              sign in
            </Link>
            ...
            <Link
              to="/sign-up"
              className="w-1/3 pb-4 font-medium text-center text-gray-800 capitalize border-b-2  dark:border-blue-400 dark:text-white"
            >
              sign up
            </Link>
          </div>
